 ...
 if (input[index].equals("!") || input[index].equals("IntConst") || input[index].equals("CharConst") || input[index].equals("StringConst")
  || input[index].equals("FloatConst") || input[index].equals("ID") || input[index].equals("(") || input[index].equals("call")) {
    ...
    private static boolean ARG() {
        if (input[index].equals("DT")||input[index].equals("void")) {
...
//        }
    ...
    private static boolean Edash() {
        ...
        else if (input[index].equals("RelOpr")||input[index].equals("&&")||input[index].equals("||")
                ||input[index].equals(",")||input[index].equals(")")||input[index].equals(";")||input[index].equals("]")) {
            return true;
        }
    ...
    private static boolean OEdash() {
        ...
        else if (input[index].equals(",")||input[index].equals(")")||input[index].equals(";")||input[index].equals("]")) {
           return true; 
        }
 ...
 if (input[index].equals("!") || input[index].equals("IntConst") || input[index].equals("CharConst") || input[index].equals("StringConst")
   ...
   else if (input[index].equals(";")||input[index].equals(".")||input[index].equals("[")||input[index].equals("MDM")||input[index].equals("PlusMinus")||
            input[index].equals("RelOpr")||input[index].equals("&&")||input[index].equals("||")||input[index].equals(",")||input[index].equals("]")
            ||input[index].equals(")")){
                return true;
            }
